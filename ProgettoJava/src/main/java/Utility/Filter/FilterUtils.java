...
public class FilterUtils<T> {
	 ...
	 * La classe ritorna comunque una collezione di tipo Farmacia (in generale di tipo T), essendo un filtraggio di questo genere più significativo (ad esempio, permette di filtrare tutte le Farmacie nello stesso comune, provincia etc.).
	 * @param Collection<T> src - collection da filtrare
	 * @param fieldName - campo da filtrare
	 * @param value - valore con cui si effettuano i confronti
	 * @param operator - operatore scelto per i confronti
